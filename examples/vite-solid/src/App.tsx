		...
		<main class="mx_auto max-width:1000px px_md py_xl7 md:px_xl">
			<div class="column gap_lg">
				<header class="text-align:center">
					<h1>fuz_css + Solid</h1>
					<p>Utility classes generated on-demand via Vite plugin (<a href="https://css.fuz.dev/docs/classes">docs</a>, <a href="https://github.com/fuzdev/fuz_css/tree/main/examples/vite-solid">source</a>)</p>
				</header>
				...
				<section>
					...
					<div>
						...
						<div class="row gap_md mb_lg">
							<button class="hover:border_palette_b_50 hover:outline_palette_b_50 active:border_palette_d_50 active:outline_palette_d_50" onClick={() => setCount((c) => c + 1)}>
								count: {count()}
							</button>
							<span>.hover:border_palette_b_50 .hover:outline_palette_b_50 .active:border_palette_d_50 .active:outline_palette_d_50</span>
						</div>
						<div class="row gap_md mb_lg">
							<button class="hover:border_palette_g_50 hover:outline_palette_g_50 active:border_palette_h_50 active:outline_palette_h_50" onClick={() => setCount(0)}>
								reset
							</button>
				...
				<footer class="text-align:center">
					<p>This demos a subset of features.<br />See the <a href="https://css.fuz.dev/docs/classes">docs</a> and <a href="https://github.com/fuzdev/fuz_css/tree/main/examples/vite-solid">source code</a> for more.</p>
				</footer>
			</div>
		</main>
	);
