			...
			<div className="column gap_lg">
				<header className="text-align:center">
					...
					<p>
						...
						<a href="https://github.com/fuzdev/fuz_css/tree/main/examples/vite-react">source</a>)
					</p>
				</header>
				...
				<section>
					...
					<div>
						...
						<div className="color:var(--palette_j_50)">.color:var(--palette_j_50)</div>
						<div className="box-shadow:0~4px~8px~rgb(0,0,0,0.2)">
				...
				<section>
					...
					<div>
						...
						<p className="min-width(543px):font_size_lg">
					...
					<div>
						...
						<div className="row gap_md mb_lg">
							<button
								className="hover:border_b_50 hover:outline_b_50 active:border_d_50 active:outline_d_50"
						...
						<div className="row gap_md mb_lg">
							<button
								className="hover:border_g_50 hover:outline_g_50 active:border_h_50 active:outline_h_50"
								onClick={() => setCount(0)}
							>
								reset
							</button>
				...
				<footer className="text-align:center">
					<p>
						...
						<a href="https://github.com/fuzdev/fuz_css/tree/main/examples/vite-react">
							source code
						</a>{' '}
						for more.
					</p>
