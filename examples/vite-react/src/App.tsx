				...
				<section>
					...
					<div>
						...
						<div className="row gap_md mb_lg">
							<button
								className="hover:border_color_b_50 hover:outline_color_b_50 active:border_color_d_50 active:outline_color_d_50"
						...
						<div className="row gap_md mb_lg">
							<button
								className="hover:border_color_g_50 hover:outline_color_g_50 active:border_color_h_50 active:outline_color_h_50"
								onClick={() => setCount(0)}
							>
								reset
							</button>
