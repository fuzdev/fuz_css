...
/**
 * An era probe theme: grayscale, sharp, flat, border-forward. The entire
 * color system collapses to neutral grays with two knob moves; shape and
 * depth flatten; borders carry the structure.
 *
 * Declared subversions: every status color renders gray — semantics carry
 * through text and weight alone.
 *
...
export const brutalist_theme: Theme = {
	name: 'brutalist',
	variables: [
		// grayscale: zero the palette chroma and the neutral tint
