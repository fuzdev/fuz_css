...
${'<' as string}script>
	...
	// ...
		...
		<p>
			...
			uses. There are two ways to generate it: the <strong>Vite plugin</strong> (recommended for
			non-Svelte projects) or the <strong>Gro generator</strong> (recommended for SvelteKit projects).
		</p>
...
declare module 'virtual:fuz.css' {
  ...
  export default css;
		...
		<TomeSection>
			...
			<p>
				For SvelteKit projects using <a href="https://github.com/ryanatkn/gro">Gro</a>, create a
				generator file:
			</p>
			<Code
				lang="ts"
				content={`// src/routes/fuz.gen.css.ts
import {gen_fuz_css} from '@fuzdev/fuz_css/gen_fuz_css.js';

export const gen = gen_fuz_css();`}
			/>
			<p>Then import the generated file in your layout:</p>
			<Code
				content={`<!-- +layout.svelte -->
${'<' as string}script>
  import '@fuzdev/fuz_css/style.css';
  import '@fuzdev/fuz_css/theme.css';
  import '$routes/fuz.css'; // generated by Gro
</script>`}
			/>
		</TomeSection>
