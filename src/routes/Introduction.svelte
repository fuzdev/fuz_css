...
<p>
	...
	other JSX frameworks. See <a href="https://ui.fuz.dev/">Fuz UI</a> for the companion Svelte
	components and the
	<a href={resolve('/docs/classes#Framework-support' as any)}>framework support docs</a>.
</p>
<p>
